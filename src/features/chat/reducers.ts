...
export default {
    ...
    setIsActiveStatus: (state: IUsers, action: PayloadAction<boolean>) => {
        state.isActive = action.payload;
    },
    setUsersConveration: (state: IUsers, action: PayloadAction<Conversation[]>) => {
        state.conversations.push(...action.payload)
    },
    clearConverations: (state: IUsers) => {
