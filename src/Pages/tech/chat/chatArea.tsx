      ...
      .pipe(
        map((changes: any) => {
          ...
          changes.forEach((element: any) => {
            if (
              (element.snapshot.val().user_uid_1 === uid_1 &&
                element.snapshot.val().user_uid_2 === uid_2 &&
                element.snapshot.val().from === role) ||
              (element.snapshot.val().user_uid_1 === uid_2 &&
                element.snapshot.val().user_uid_2 === uid_1 &&
                element.snapshot.val().from === UserRole.USER)
            )
              data.push({
                ...element.snapshot.val(),
                key: element.snapshot.key,
              });
          });
          return data;
        })
              ...
              return (
                ...
                >
                  <Box
                    ...
                    flexDirection="row"
                    justifyContent={
                      message.user_uid_1 === uid_1 ? "flex-start" : "flex-end"
                    }
                  >
              ...
              >
                ...
                >
                  <TextPaper
                    style={{
                      background:
                        message.user_uid_1 === uid_1 ? "#7B1FA2" : "#716BE4",
                    }}
                  >
                    {message.message}
                  </TextPaper>
