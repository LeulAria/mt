...
export default function PageForm() {
    ...
    const sendEmail = (data : any, e: any) => {
        ...
        emailjs.sendForm('service_ksd1yt9', 'template_v1h99b8',
            e.target
                ...
                <Paper className={classes.parent} elevation={4}>
                    <Box display="flex" flexDirection="column" justifyContent="center">
                        ...
                        >
                            ...
                            <Box display="flex" flexDirection="row" justifyContent="center" mt={3} px={10}>
                            ...
                            <Box display="flex" flexDirection="row" justifyContent="center" my={3} px={10}>
                                <Box mx={1}><Safe /></Box>
                                <Box fontWeight={700} fontSize="13px">We Keep Your Data Safe</Box>
                            </Box>
                        </form>
                    </Box>
                </Paper>
            </Box>
            <Snackbar open={open} handleClick={handleClick} handleClose={handleClose} type={type} message={message} />
        </div>
    )
}